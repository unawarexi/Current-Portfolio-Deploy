...
const About = () => {
  ...
  <div className="container mx-auto flex lg:flex-row flex-col items-center justify-center px-4 py-20">
  {/* Profile Image */}
  <div className="lg:w-[40%] w-full mb-10 lg:mb-0 flex justify-center">
  {/* Outer ring with purple border */}
  <div className="rounded-full border-4 border-indigo-500 p-2 bg-white shadow-xl">
    {/* Inner div containing the image */}
    <div className="rounded-full overflow-hidden">
      <img
        className="object-cover object-center w-[200px] h-[200px] rounded-full transform rotate-12 hover:rotate-0 transition-transform duration-300"
        alt="profile"
        src={Images.aboutImg}
      />
    </div>
  ...
  {/* About Me Content */}
  <div className="lg:w-[60%] w-full lg:pl-12 flex flex-col items-start text-left">
    <div className="bg-indigo-300 bg-opacity-20 backdrop-blur-lg rounded-3xl px-6 py-8 mb-8 w-full">
      <h1 className="title-font md:text-5xl text-xl mb-4 font-bold text-gray-900">
        <span className="text-blue-500 block md:inline">Welcome,</span> <br />
        I'm <span className="text-blue-600">Andrew Chukwuweike</span>
        <br />
        <span className="text-indigo-500">Software Developer</span>
      </h1>
      <p className="mb-8 leading-relaxed text-gray-700 md:text-md text-sm">
        With a background in both frontend and backend development, I specialize in building full-stack web applications that are robust, user-friendly, and efficient. My expertise includes working with JavaScript, React, Node.js, and more. I love solving complex problems and delivering high-quality code that makes a difference.
      </p>
    </div>
