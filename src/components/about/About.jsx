...
const About = () => {
  ...
  <img className="object-cover object-center rounded-3xl shadow-lg transform rotate-12 hover:rotate-0 transition-transform duration-300" alt="profile" src={Images.aboutImg} />
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16  flex flex-col md:items-start md:text-left items-center text-left">
          <h1 className="title-font sm:text-4xl text-xl mb-4 font-medium text-gray-900 -ml-20 md:-ml-0">
          ...
          <div className="flex justify-center ">
            <a href="#projects">
              <button className="inline-flex text-white bg-indigo-500 border-0 py-2 md:px-6 px-4 focus:outline-none hover:bg-indigo-600 rounded md:text-lg text-sm ">
                View Projects
              </button>
            </a>
            <a href="#contact" className="ml-4">
              <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 md:px-6 px-4 focus:outline-none hover:bg-gray-200 rounded md:text-lg text-sm">
                Contact Me
              </button>
            </a>
          </div>
