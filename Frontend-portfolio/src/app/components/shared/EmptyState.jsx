...
import { FileQuestion, Search, Inbox, AlertCircle, RefreshCw } from '@core/constants/icons';
...
export const EmptyState = ({
  ...
  return (
    ...
    >
      ...
      {/* Description */}
      {displayDescription && (
        <p className={cn('text-neutral-500 dark:text-neutral-400 max-w-sm mb-6', styles.description)}>
          {displayDescription}
        </p>
      )}
