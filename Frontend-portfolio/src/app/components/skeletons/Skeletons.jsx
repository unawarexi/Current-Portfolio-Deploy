...
// ========================
// PROJECT CARD SKELETON — portfolio grid placeholder
// ========================
export const ProjectCardSkeleton = () => (
  <motion.div
    className="rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-700/50 bg-white dark:bg-neutral-800/60"
    initial={{ opacity: 0, y: 10 }}
    animate={{ opacity: 1, y: 0 }}
  >
    <SkeletonBlock className="h-48 w-full" rounded="rounded-none" />
    <div className="p-4">
