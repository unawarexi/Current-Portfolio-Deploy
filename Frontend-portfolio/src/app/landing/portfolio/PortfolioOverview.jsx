  ...
  <motion.div variants={staggerItem} className="h-full">
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4">
        <h3 className="font-display text-sm font-semibold text-gray-900 dark:text-white tracking-wide mb-1.5 line-clamp-1">
          {project.title}
        </h3>
        <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed flex-1 mb-3 line-clamp-2">
          {project.description}
        </p>
        {/* Tech chips */}
        ...
        {!isLoading && hasMore && (
          <div className="text-center mt-12">
            <button
              ...
              className="inline-flex items-center gap-2 px-7 py-3 rounded-full border border-primary-500/40 text-primary-600 dark:text-primary-400 text-sm font-semibold hover:bg-primary-500 hover:text-white transition-all duration-200"
            >
              Show more projects <ChevronRight size={16} />
            </button>
          </div>
        )}
      </div>
