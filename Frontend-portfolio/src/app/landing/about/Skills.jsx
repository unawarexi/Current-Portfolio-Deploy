    ...
    >
      ...
      {isFeature && (
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-2.5 p-3">
          ...
          <span
            className="font-mono text-[9px] md:text-[10px] lg:text-[11px] font-semibold
      ...
      {isWide && (
        <div className="relative z-10 flex h-full items-center gap-2.5 px-3">
          ...
          />
          <span
            className="font-mono text-[7px] md:text-[8px] lg:text-[10px]
      ...
      {isTall && (
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-2 p-2">
          ...
          />
          <span
            className="font-mono text-[7px] md:text-[8px] lg:text-[9px]
      ...
      {!isFeature && !isWide && !isTall && (
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-1 p-1.5">
          ...
          />
          <span
            className="font-mono text-[6px] md:text-[7px] lg:text-[7.5px]
...
const CarouselCard = ({ skill }) => (
  <motion.div variants={staggerItemBig}>
    <TiltCard intensity={15}>
      <div
        className="group flex w-[4.5rem] sm:w-24 flex-col items-center justify-center gap-2 sm:gap-3 rounded-xl sm:rounded-2xl
        border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/[0.03]
        px-2.5 py-3 sm:px-4 sm:py-5 shadow-sm transition-all duration-300
        hover:border-primary-500/50 hover:shadow-2xl hover:shadow-primary-500/20"
      >
        <div className="relative h-7 w-7 sm:h-10 sm:w-10 flex items-center justify-center">
          <div
            className="absolute inset-0 scale-0 rounded-full bg-primary-500/20 blur-xl
        ...
        <Badge
          variant="default"
          size="sm"
          className="mt-1 text-[5px] sm:text-[9px] px-1.5 py-0.5 sm:px-2.5 sm:py-1"
        >
          {skill.name}
        </Badge>
      </div>
...
const Skills = () => {
  ...
  const prev = () =>
    setCurrent((c) => (c === 0 ? skillSets.length - 1 : c - 1));
  const next = () =>
    setCurrent((c) => (c === skillSets.length - 1 ? 0 : c + 1));
        ...
        {isLarge && (
          <div className="relative max-w-5xl mx-auto mt-8">
            ...
            <div className="flex justify-center mt-8">
              <span
                className="rounded-full border border-gray-200 dark:border-white/[0.08]
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <motion.div
                  ...
                  initial="hidden"
                  animate="visible"
                  className="flex flex-wrap justify-center gap-2 sm:gap-4 px-2 py-4 sm:px-6 sm:py-8"
                >
